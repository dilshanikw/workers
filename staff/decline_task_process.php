...
if(isset($_POST['submit'])){
	...
	$description = $_POST['txt_decline_reason'];
				...
				$query = "UPDATE assign_task SET taskassign_decline_reason='$description',taskassign_complete_status=3 WHERE assigntask_id='$_GET[as]'";
				if(mysqli_query($link,$query))
				{
					...
					$to=$cordinatior_email;
						...
						$subject="".$uadmin_first." ".$uadmin_last." has rejected the task ".$task_nme." ";				//subject eka danna
						$msg1="Dear  Coordinator\r\n"
							."".$uadmin_first." ".$uadmin_last." has rejected the task ".$task_nme." due to ".$description.". \r\n"
							."Thank You\r\n"
							."WorkTracker\r\n";				
						
						$ok3=mail($to,$subject,$msg1);
						if($ok3){
							$messagess="&nbsp; Sucessfully Decline Request Task Progress and Message Sent!";
							$flagmsg=1;
						}
						else{
							$messagess="&nbsp; Sucessfully Decline Request Task Progress and Message Not Sent!";
							$flagmsg=1;
						}
				}
				else
...
<head>
  ...
  <title>WorkTracker | Decline Task</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Decline Task</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Decline Task</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Decline Task</h3>

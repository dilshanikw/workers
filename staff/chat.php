        ...
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <div class="card-body">
						...
						<label>Select Receiver</label>
							...
							<select class="form-control" name="reciver" id="reciver" style="width: 100%;" onchange="this.form.submit()">
								<?php
									...
									$que2="SELECT * FROM staff WHERE NOT empno='$ses_ukey' ORDER BY empno ASC";
				...
				if(isset($_POST['reciver'])){
					if($_POST['reciver']=="Coordinator"){
						$que4="SELECT DISTINCT(sent_dte) AS disdateofmsg FROM chat WHERE (sender_id='$ses_ukey' AND senderuserlevel='Staff' AND receiver_userlevel='Coordinator') OR 
																						 (senderuserlevel='Coordinator' AND receiverID='$ses_ukey' AND receiver_userlevel='Staff') ORDER BY chatID ASC";
						$rslt4=mysqli_query($link,$que4);
						while($row4=mysqli_fetch_array($rslt4)){
						
				?>	
							<?php
								$que6="SELECT * FROM chat WHERE sender_id='$ses_ukey' AND senderuserlevel='Staff' AND receiver_userlevel='Coordinator' AND sent_dte='$row4[disdateofmsg]'";
								$rslt6=mysqli_query($link,$que6);
								if(mysqli_num_rows($rslt6)==0){
								?>
									<?php
									$que7="SELECT * FROM chat WHERE senderuserlevel='Coordinator' AND receiverID='$ses_ukey' AND receiver_userlevel='Staff' AND sent_dte='$row4[disdateofmsg]'";
								...
								?>
									<?php
									$que8="SELECT * FROM chat WHERE sender_id='$ses_ukey' AND senderuserlevel='Staff' AND receiver_userlevel='Coordinator' AND sent_dte='$row4[disdateofmsg]'";
				...
				<?php			
					...
					//employee message start
					else{
						$que4="SELECT DISTINCT(sent_dte) AS disdateofmsg FROM chat WHERE (sender_id='$ses_ukey' AND senderuserlevel='Staff' AND receiverID='$_POST[reciver]' AND receiver_userlevel='Staff') OR 
																						 (sender_id='$_POST[reciver]' AND senderuserlevel='Staff' AND receiverID='$ses_ukey' AND receiver_userlevel='Staff') ORDER BY chatID ASC";
						$rslt4=mysqli_query($link,$que4);
						while($row4=mysqli_fetch_array($rslt4)){
				?>
								<?php
								$que6="SELECT * FROM chat WHERE sender_id='$ses_ukey' AND senderuserlevel='Staff' AND receiverID='$_POST[reciver]' AND receiver_userlevel='Staff' AND sent_dte='$row4[disdateofmsg]'";
								$rslt6=mysqli_query($link,$que6);
								if(mysqli_num_rows($rslt6)==0){
								?>
									<?php
									$que7="SELECT * FROM chat WHERE sender_id='$_POST[reciver]' AND senderuserlevel='Staff' AND receiverID='$ses_ukey' AND receiver_userlevel='Staff' AND sent_dte='$row4[disdateofmsg]'";
									$rslt7=mysqli_query($link,$que7);
									$queryinfo7=mysqli_fetch_assoc($rslt7);
								...
								?>
									<?php
									$que8="SELECT * FROM chat WHERE sender_id='$ses_ukey' AND senderuserlevel='Staff' AND receiverID='$_POST[reciver]' AND receiver_userlevel='Staff' AND sent_dte='$row4[disdateofmsg]'";
									$rslt8=mysqli_query($link,$que8);
									$queryinfo8=mysqli_fetch_assoc($rslt8);	
									?>
									<tr>

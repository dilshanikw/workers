									  ...
									  <?php
										...
										while($test = mysqli_fetch_array($result7))
										{
											$no++;			
													...
													echo"<td>"; 
														echo " <a class='btn btn-primary btn-sm' href='assingsubtask_process.php?as=$test[assigntaskID]' target='_blank'>
										...
										while($test = mysqli_fetch_array($result8))
										{
											$no++;			
													...
													echo"<td>"; 
														echo " <a class='btn btn-primary btn-sm' href='assingtask_process.php?as=$test[assigntask_id]' target='_blank'>
														  <i class='fas fa-paper-plane'>
														  </i>
														 Send Progress
														</a>";

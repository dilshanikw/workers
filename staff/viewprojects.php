        ...
        <div class="col-md-12">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Process Projects</h3>
					...
					<tbody>
					  <?php
						...
						$result=mysqli_query($link,"SELECT * FROM project INNER JOIN staff ON project.responsiblePerson=staff.empno
																		  INNER JOIN assign_subtask ON project.projectID =assign_subtask.projectID
																			WHERE 
						...
						while($test = mysqli_fetch_array($result))
						{
							$no++;			
									...
									echo"<td>" .$test['projectDesc']."</td>";
									echo"<td>" .$test['firstname']."" .$test['lastname']."</td>";
									echo"<td>" .$test['client']."</td>";
									echo"<td>"; 
											echo " <a class='btn btn-primary btn-sm' href='project_detail.php?ids=$test[projectID]' target='_blank'>

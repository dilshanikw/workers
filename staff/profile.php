...
{	
	...
	if($scurrentpass==$upass){
		if($pass==$confirm_pass){
			...
			$query1 = "UPDATE staff SET password='$spass' WHERE emp_no='$ses_ukey'";
...
if(isset($_POST['changeprofile'])){
            ...
            $fileType = pathinfo($target_file,PATHINFO_EXTENSION);
				...
				if (file_exists($target_new)) {
						...
						$sql42="UPDATE staff SET profile_pic='$awers1' WHERE empno='$ses_ukey'";
...
if(isset($_POST['changetheme'])){
	if($utheme=='dark-mode'){
		$chgtheme1 = "UPDATE staff SET theme = 'light-mode' WHERE empno = '$ses_ukey'";
		...
		$chgtheme2 = "UPDATE staff SET theme = 'dark-mode' WHERE empno = '$ses_ukey'";
              ...
              <div class="card-body">
                <div class="tab-content">
					<div class="active tab-pane" id="activity">
						...
						<div class="form-group row">
								<div class="col-sm-10">
									<a href="update_infoprofile.php?ep=<?php echo $ses_ukey; ?>"><button class="btn btn-info">Update Information</button></a>
								</div>
						</div>

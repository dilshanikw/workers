...
<head>
  ...
  <title>WorkTracker | All Tasks - Project Wise</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Tasks Report - Project Wise</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Reports</a></li>
              <li class="breadcrumb-item active">Tasks Report - Project Wise</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
	...
	<form name="formtasks" action="tcpdf/reports/tasks_projectwise.php" method="post" target="_blank">
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Tasks Report - Project Wise</h3>
            ...
            <div class="card-body">
				<div class="form-group">
					...
					<select class="form-control" name="projects" id="projects" style="width: 100%;">
						<?php
							...
							while($row1=mysqli_fetch_array($result1)){
								$option1 = $option1."<option value=$row1[projectID]>$row1[projectID] - $row1[projectName]</option>";			//Load projects
							}

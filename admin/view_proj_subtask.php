...
<head>
  ...
  <title>WorkTracker | Project Sub Task</title>
			...
			<div class="col-md-12">
				  <div class="card card-primary">
					<div class="card-header">
					  <h3 class="card-title">Project Sub Task</h3>
					...
					<div class="card-body p-0">
						...
						<table class="table" border="1">
							...
							<tbody>
								<?php
								$no=0;
								$result4=mysqli_query($link,"SELECT * FROM subtask INNER JOIN task ON subtask.taskID=task.taskID
																WHERE subtask.projectID='$_GET[pr]'");
								while($test4 = mysqli_fetch_array($result4))
								{
									...
									echo "<tr>";
										...
										echo"<td>" .$test4['subtaskName']."</td>";
										echo"<td>" .$test4['subtaskDesc']."</td>";
										echo"<td>" .$test4['subtaskstartDate']."</td>";
										echo"<td>" .$test4['subtasktargetDate']."</td>";

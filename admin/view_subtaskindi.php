          ...
          <div class="card card-primary">
			...
			<br>
				...
				<div class="row">	
					...
					<div class="col-4">	
						<a href="upd_subtask.php?tkd=<?php echo $_GET['sb'];?>"><button  class="btn btn-info float">Update</button></a>
					</div>
				</div>
			...
			<form role="form" method="Post" name="f5">
					...
					<div class="row">
						<div class="col-12">
						<label>Assign a Staff Member:</label>
			...
			<table>
						...
						$sql1="SELECT * FROM assign_subtask INNER JOIN staff ON assign_subtask.staffID=staff.empno WHERE 
										assign_subtask.subtaskID='$_GET[sb]'";

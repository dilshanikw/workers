...
if(isset($_POST['submit']))
{
	...
	if($password!=$confirmpassword){
		...
		$flagmsg=0;
			...
			$query1 = "UPDATE coordinator SET password='$sspassword' WHERE codinator_key='$ses_ukey'";
        ...
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <div class="card-body">
					...
					<div class="form-group">
						<label for="staffID">Password must include 8characters, 1 Upper Case letter, 1 lower case letter and a symbol</label>
					</div>
					<div class="row">
						<div class="col-12">

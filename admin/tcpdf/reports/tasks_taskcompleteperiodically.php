						...
						$html ='<table border="0"  width="100%">
									<tr>
										<td width="100%" >
											...
											<div style="font-size:18px;font-weight:bold;" align="center">Tasks Completed - Periodically </div>
											<div style="font-size:13px;" align="center">'.$startdate.' to '.$enddate.'</div>
...
$pdf->SetTitle('Tasks - Completed Periodically');
		...
		$html='
			...
			<table border="1" width="100%">
				...
				$result=mysqli_query($link,"SELECT * FROM task INNER JOIN project ON task.projectID=project.projectID
											...
											AND task.endDate>='$startdate'
											AND task.endDate<='$enddate'");
			...
			<table border="1" width="100%">
				...
				$result2=mysqli_query($link,"SELECT * FROM subtask INNER JOIN project ON subtask.projectID=project.projectID
											...
											WHERE subtask.subtask_status=1
											AND subtask.subtaskendDate>='$startdate'
											AND subtask.subtaskendDate<='$enddate'");
				while($test2 = mysqli_fetch_array($result2))
				{
					...
					$html.='<tr style="font-size:10px;">';
						...
						<td width="10%"> '.$test2['subtaskendDate'].'</td>';
...
$pdf->Output('taskcompleteperiodically_'.$startdate.'_'.$enddate.'.pdf', 'I');

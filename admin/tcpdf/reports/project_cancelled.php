						...
						$html ='<table border="0"  width="100%">
									<tr>
										<td width="100%" >
											...
											<div style="font-size:18px;font-weight:bold;" align="center">Cancelled Projects</div>
			...
			<table border="1" width="100%">
				...
				while($test = mysqli_fetch_array($result))
				{
					...
					$html.='<tr style="font-size:10px;">';
						...
						<td width="15%"> '.$test['cancelled_date'].'</td>
						';
...
$pdf->Output('Cancelledprojectreport_'.$cur_dte.'.pdf', 'I');

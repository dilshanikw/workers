						...
						$html ='<table border="0"  width="100%">
									<tr>
										<td width="100%" >
											...
											<div style="font-size:18px;font-weight:bold;" align="center">Complete Projects Reports</div>
...
$pdf->SetTitle('Complete Project Reports');
		...
		$html='
			<table border="1" width="100%">
				...
				$result=mysqli_query($link,"SELECT * FROM project INNER JOIN staff ON project.responsiblePerson=staff.empno
																							...
																							AND project.complete_dte>='$ss1'
																							AND project.complete_dte<='$ss2'");
				...
				while($test = mysqli_fetch_array($result))
				{
					...
					$html.='<tr style="font-size:10px;">';
						...
						<td width="15%"> '.$test['complete_dte'].'</td>
						';
...
$pdf->Output('Completeproject_'.$ss1.'_'.$ss2.'.pdf', 'I');

						...
						$html ='<table border="0"  width="100%">
									<tr>
										<td width="100%" >
											...
											<div style="font-size:18px;font-weight:bold;" align="center">Projects Reports - '.$ss1.'</div>
...
$pdf->Output('projectclientwise_'.$ss1.'_'.$cur_dte.'.pdf', 'I');

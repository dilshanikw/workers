...
<head>
  ...
  <title>WorkTracker | Manage User Accounts</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Manage User Accounts</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
				<table class="table table-striped table-hover" id="projects">
					...
					<?php
						$no=0;
						$result1=mysqli_query($link,"SELECT * FROM staff");
						while($test1 = mysqli_fetch_array($result1))
						{
							$no++;			
									echo "<tr>";
									echo"<td>" .$no."</td>";
									echo"<td>" .$test1['firstname']." " .$test1['lastname']."</td>";
									echo"<td>" .$test1['namewithinitials']."</td>";
									echo"<td>" .$test1['city']."</td>";
									echo"<td>" .$test1['contact_no']."</td>";
									echo"<td>" .$test1['email']."</td>";
									echo"<td>"; 
											echo " <a class='btn btn-primary btn-sm' href='staffprofile.php?ids=$test1[empno]'>
														  <i class='fas fa-eye'>
														  </i>
														  View User
													</a>";
